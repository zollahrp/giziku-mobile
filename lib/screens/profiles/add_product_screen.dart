...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  void initState() {
    ...
    _expiredDateController.text = widget.product.expiredDate;
    ...
    _selectedDate = widget.product.expiredDate.isNotEmpty
        ...
        : null;
    _location = widget.product.location.latitude != 0 || widget.product.location.longitude != 0
  ...
  Future<void> _saveProduct() async {
    ...
    final newProduct = ProductModel(
      ...
      location: _location ?? ProductLocation(latitude: 0, longitude: 0, address: ""),
      imageUrl: _uploadedImageUrl ?? "",
      expiredDate: _expiredDateController.text,
    );

    final repo = ProductRepository(apiUrl: 'https://api.yourdomain.com'); // Ganti ke alamat API kamu

    final success = await repo.addProduct(newProduct);
