...
class SimulationStep3 extends StatefulWidget {
  ...
  const SimulationStep3({super.key, required this.budget, required this.days});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  // Validate and convert people
                  final peopleText = _budgetController.text.trim();
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => SimulationOverviewScreen(
