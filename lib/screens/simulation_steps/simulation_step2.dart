...
class SimulationStep2 extends StatefulWidget {
  ...
  const SimulationStep2({super.key, required this.budget});
...
class _SimulationStep2State extends State<SimulationStep2> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  final daysText = _budgetController.text.trim();
                  if (daysText.isEmpty) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Please enter the number of days'),
                      ),
                    );
                    return;
                  }
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          SimulationStep3(budget: widget.budget, days: days),
                    ),
                  );
                },
                child: Container(
  ...
  Widget _buildStepLine() {
    return Container(width: 32, height: 2, color: Colors.grey.shade300);
  }
}
